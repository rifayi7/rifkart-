...
export default function BestSelling() {
  return (
    <div className="flex flex-col space-y-4 text-tiddy-black mb-[40px]">
      <h1 className="font-bold text-black">Best selling</h1>
      <div className="flex gap-3">
        <div className="left w-[75px] h-[75px] border border-neutral-300 rounded-lg overflow-hidden">
          <img
            src={img1}
            alt="img1"
            className="object-cover w-full h-full hover:scale-125 transition duration-300 ease-in-out"
          />
        </div>
        <div className="right text-[15px] flex flex-col justify-evenly font-medium">
          <h2>Justo Finibus</h2>
